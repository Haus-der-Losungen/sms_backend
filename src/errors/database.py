...
class AlreadyExistsError(DatabaseError):
    ...
    def __init__(self, entity_name: str, entity_identifier: Optional[str] = None) -> None:
        """Initializes the error with the entity name and an optional identifier."""
        message = f"{entity_name.capitalize()} already exists"
        if entity_identifier:
            message += f" with {entity_identifier}"
